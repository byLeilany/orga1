...
void pic_reset() {
  ...
  outb(PIC1_PORT + 1, 0x8);  // mov al, 8   ;ICW2: INT base para el PIC1 Tipo 8.                     --    out 21h, al
  ...
  outb(PIC2_PORT + 1, 0x70);  // mov al, 70h ;ICW2: INT base para el PIC2 Tipo 070h.                 --    out A1h, al
